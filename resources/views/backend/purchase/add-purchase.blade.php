                ...
                <section class="col-lg-12 ">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3>Add Purchase
                                <a class="btn btn-success float-right " href="{{route('purchase.view')}}"><i class="fa fa-plus">Purchase List</i></a>
                            </h3>
                        </div><!-- /.card-header -->
                        <div class="card-body">
                            <form method="post" action="{{route('purchase.store')}}" id="myForm" enctype="multipart/form-data">
                                @csrf
                                <div class="form-row">
